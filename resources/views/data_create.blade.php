        ...
        <div class="content">
            ...
            <form action="{{ route('data.store') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input disabled='disabled' type="text" class="form-control" id="paslon1" name="paslon1" value="0">
                </div>
                <div class="form-group">
                    <label for="paslon2">paslon 2:</label>
                    <input disabled='disabled' type="text" class="form-control" id="paslon2" name="paslon2" value=" 0">
                </div>
                <div class="form-group">
